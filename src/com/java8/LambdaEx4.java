...
public class LambdaEx4 {
	...
	public static void main(String args[]) {
		LambdaEx4 tester = new LambdaEx4();
		...
		GreetingService greetService1 = message -> System.out.println("Hello " + message); // without parenthesis
		GreetingService greetService2 = (message) -> System.out.println("Hello " + message); // with parenthesis
